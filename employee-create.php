            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    if(isset($_GET['status'])){
                        if($_GET['status'] === 'success'){
                            ?>
                                    ...
                                    <i class="fa fa-check"></i><a> Employee created successfully!.</a>
                    ...
                    ?>
                        ...
                        <form class="card" action="actions/createemployee.php" method="post">
                            <div class="card-header">
                                <strong>Employee Create</strong><small></small>
                                <a href="employeedetails.php" class="btn btn-secondary pull-right"><i class="fa fa-chevron-left"></i> Employees </a>
                            </div>
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <label for="fname" class=" form-control-label">Employee Name</label>
                                    <input type="text" id="ename" name="ename" placeholder="Enter your first name" class="form-control" required>
                                </div>
                                <div class="form-group">
