<?php
    ...
    $userid = $_GET['id'];
    $user = mysqli_fetch_array(mysqli_query($conn, "select * from employeedetails where eid = $userid"));
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    if(isset($_GET['status'])){
                        if($_GET['status'] === 'success'){
                            ?>
                                    ...
                                    <i class="fa fa-check"></i><a> Employee updated successfully!.</a>
                    ...
                    ?>
                        ...
                        <form class="card" action="actions/updateemployee.php" method="post">
                            <div class="card-header">
                                <strong>Update Create</strong><small></small>
                                <a href="employeedetails.php" class="btn btn-secondary pull-right"><i class="fa fa-chevron-left"></i> Employees </a>
                            </div>
                            <div class="card-body card-block">
                                <input type="hidden" name="eid" value="<?php echo $user['eid']; ?>">
                                <div class="form-group">
                                    <label for="ename" class=" form-control-label">Employee Name</label>
                                    <input type="text" id="ename" name="ename" value="<?php echo $user['ename']; ?>" placeholder="Enter your first name" class="form-control" required>
                                </div>
                                <div class="form-group">
