        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="card-header"><strong>Maintenance Report</strong><small></small>
                            <a href="outstanding-details.php" class="btn btn-secondary btn-sm pull-right"><i class="fa fa-chevron-left"></i>outstanding</a>
