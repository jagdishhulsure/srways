                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="vehiclenumber" placeholder="Enter your vehicle number" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="chessinumber" class=" form-control-label">Chessi Number</label>
                                    <input type="text" id="chessinumber" placeholder="Enter your chessi number" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="npnumber" class=" form-control-label">N/P Number</label>
                                    <input type="text" id=" " placeholder="Enter your N/P number" class="form-control">
                                </div>
                                        <div class="form-group">
                                            <label for="tax" class=" form-control-label">Tax</label>
                                            <input type="text" id="tax" placeholder="Enter your tax number" class="form-control">
                                        </div>
                                    <div class="form-group">
                                        <label for="fc" class=" form-control-label">FC</label>
                                        <input type="text" id="fc" placeholder="FC" class="form-control">
                                    </div>
                                
                                <div class="form-group">
                                    <label for="insurance" class=" form-control-label">Insurance</label>
